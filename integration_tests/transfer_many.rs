...
use bitcoin::Amount;
use coinshift::{types::GetValue as _, wallet::TransferDests};
...
async fn transfer_many_task(
    ...
    .await?;
    tracing::info!("Setup Coinshift node successfully");
    ...
    tracing::debug!("Checking that the transfer pays each address");
